...
import { widgetItems, sidebarItems } from '../lib/constants/app.constant';
                    ...
                    render={() => (
                        <FormItem className="space-y-4">
                            <div className="mb-4">
                                ...
                                <FormDescription>
                                    Personalize your left sidebar for quick access to essential
                                    features.
                                </FormDescription>
                            </div>
                    ...
                    render={() => (
                        <FormItem className="space-y-4">
                            <div className="mb-4">
                                ...
                                <FormDescription>
                                    Select the widgets that matter most for quick access.
                                </FormDescription>
                            </div>
